    ...
    <div ng-controller="MainController" ng-cloak style="height: 100%">
        ...
        <section id="left-sidebar" ed-tabs="basics" class="md-whiteframe-z1">
            <div id="sidebar-toggler" ed-toggle-sidebar>
                <md-button class="md-fab md-accent" aria-label="Toggle Sidebar">
                    ...
                    <div ng-controller="CropController" class="basics-item">
                        ...
                        <div data-name="crop" class="actions-menu md-whiteframe-z1"
                            ...
                            <div class="buttons">
                                ...
                                <md-button ng-click="cropper.crop()" class="md-raised">crop</md-button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div ng-controller="RotateController" class="basics-item">
                        ...
                        <div data-name="rotate" class="actions-menu md-whiteframe-z1"
                            ...
                            <div class="buttons">
                                ...
                                <md-button ng-click="applyRotation()" class="md-raised">apply</md-button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div ng-controller="ResizeController" class="basics-item">
                        ...
                        <div data-name="resize" class="actions-menu md-whiteframe-z1"
                            ...
                            <div class="buttons margin-top">
                                ...
                                <md-button ng-click="apply()" class="md-raised">resize</md-button>
                            </div>
                        </div>
                    </div>
                ...
                <section id="text" data-index="2" class="tab" ng-controller="TextController">
                    ...
                    <div data-name="text" class="actions-menu wider md-whiteframe-z1"
                        ...
                        <section class="actions-menu-inner" ng-style="{ 'max-height': maxPanelHeight }"
                            ...
                            <div class="buttons">
                                <md-button ng-click="finishAddingTextToCanvas()" class="md-accent md-raised">Save
                                </md-button>
                ...
                <section id="drawing" class="tab" data-index="3" ng-controller="DrawingController">
                    ...
                    <div data-name="drawing" class="actions-menu wider md-whiteframe-z1"
                        ...
                        <section class="actions-menu-inner" ng-style="{ 'max-height': maxPanelHeight }"
                            ...
                            <div class="buttons">
                                <md-button ng-click="finishAddingDrawingsToCanvas()" class="md-raised">Save</md-button>
                                ...
                                <section ng-if="!value.colorpicker && !value.select">
                                    <div class="md-slider">
                                        <div class="slider-label">
                                            {{ key == filters.lastAppliedFilter.name ? 'amount' : key }}
                                        </div>
        ...
        <section id="viewport">
            ...
            <section id="top-panel" class="md-whiteframe-z1" ng-controller="TopPanelController">
                ...
                <md-button ng-class="{ inactive: !objectsPanelOpen }" ng-click="toggleRightPanel('objects', $event)">
                    Layers</md-button>
                <button ng-click="openSaveDialog($event)" class="btn btn-success">Save</button>
            </section>
        ...
        <script type="application/ng-template" id="save-image-dialog">
            <md-dialog class="upload-file-dialog save-dialog">
                    ...
                    <p ng-if="imageType === 'json'">This will download a file with Share_ME editor so you can load it again into the Share_ME editor later.</p>

                    <button ng-click="saveImage($event)" class="btn btn-success">Save</button>
...
<!-- 
                        ...
                        <div class="buttons" ng-show="!canOpenImage">
                            <md-button ng-click="openImageMode = 'create'">Create New</md-button>
                        </div>
                        ...
                        <div ng-show="canOpenImage">
                            ...
                            <div class="buttons">
                                <md-button ng-click="openImage()" class="md-accent md-raised">Open</md-button>
                    ...
                    <div class="new-canvas" ng-show="openImageMode === 'create'">
                        ...
                        <div class="buttons">
                            ...
                            <button ng-click="createNewCanvas(canvasWidth, canvasHeight)" class="btn btn-success">Create</button>
                        </div>
                    </div>
                </md-dialog>
            </script>
        ...
        <script type="text/ng-template" id="modals/polygon.html">
            <md-dialog class="md-modal">
                    ...
                    <div class="buttons">
                        <md-button class="md-accent md-raised" ng-click="closeModal()">got it</md-button>
                    </div>
                </md-dialog>
        </script>
    </div>
